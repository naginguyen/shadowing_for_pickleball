    ...
    while cap.isOpened():
        ...
        if os.path.exists(ghost_path):
            ...
            if results.pose_landmarks:
                ...
                # ==============================================================================
                # [NEW] DATA LOGGING FOR REPORT
                # Only print if a person is detected and has some accuracy (filtering noise)
                if acc_score > 0:
                    print(f"DATA_LOG | Spatial_Acc: {acc_score:.4f} | Angular_Sim: {skel_score:.4f} | -> Shadow_Acceptance: {final_score:.4f} ({final_score*100:.1f}%)")
                # ==============================================================================
                # --- CONTROL LOGIC ---
            ...
            cv2.putText(frame, "Volley Complete", (50, 50), font, 1, (0,0,255), 2)
